...
// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type OrderService_StreamOrderUpdatesClient = grpc.BidiStreamingClient[OrderStatusRequest, OrderStatusResponse]
...
// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type OrderService_StreamOrderUpdatesServer = grpc.BidiStreamingServer[OrderStatusRequest, OrderStatusResponse]
